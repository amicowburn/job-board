      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-10 sm:py-14">
            ...
            <nav className="flex flex-col items-start gap-2.5">
              {footerNavItems.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="text-sm font-semibold text-slate-700 tracking-wide uppercase hover:text-slate-900 transition-colors"
                >
                  {item.label}
                </Link>
              ))}
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mt-10 pt-6 gap-4">
          ...
          <div className="flex items-center gap-5">
            <a
              href="https://www.instagram.com/the.mmss/"
              target="_blank"
            ...
            <a
              href="https://www.facebook.com/MonashMarketingStudentsSociety/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-slate-500 hover:text-slate-700 transition-colors"
              aria-label="Facebook"
            ...
            <a
              href="https://au.linkedin.com/company/monash-marketing-student-society"
              target="_blank"
              rel="noopener noreferrer"
              className="text-slate-500 hover:text-slate-700 transition-colors"
              aria-label="LinkedIn"
